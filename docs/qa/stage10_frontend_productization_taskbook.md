...
> P0 完成并通过门禁后，即进入“可演示状态（Demo Ready）”。

### 9.2 P1（契约对齐与交付完善，下一提交完成）

- OpenAPI 更新
- 补充文档
- 示例 payload

> P1 不阻塞首轮演示，但必须在下一提交中完成契约对齐并补齐交付资产。

---

## 十、CI / 验收门槛（分阶段）

### 10.1 P0 门槛（Demo Gate）

- P0 范围内的功能、接口与基础回归通过，即可标记为 `Demo Ready`。
- 发布/演示判断以 P0 结果为准，不因 P1 文档性缺口阻塞演示。

### 10.2 P1 门槛（Contract Alignment Gate）

- 在下一提交中完成 OpenAPI、文档与示例 payload 的一致性补齐。
- P1 完成后才可标记为“契约对齐完成（Contract Aligned）”。
