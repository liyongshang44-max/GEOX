...
export default function FieldRuntimeForecastTabPanel({ loadState }: { loadState?: FieldRuntimeForecastLoadState }): React.ReactElement {
  ...
  if (loadState.status === "error") return <article className="operatorFieldRuntime__panel"><h2 className="operatorFieldRuntime__panelTitle">{t("forecast")}</h2><p>{t("forecastFailed")}: {loadState.message}</p></article>;
  ...
  return (
    <div className="operatorFieldRuntime__forecastGrid" data-h60f="forecast-tab-ready" data-forecast-source={forecast.source} data-window-source={forecast.forecastWindow.source}>
      <article className="operatorFieldRuntime__panel" data-h60f-panel="forecast-intro">
        <div className="operatorFieldRuntime__panelHeader"><div><p className="operatorFieldRuntime__eyebrow">{t("forecast")}</p><h2 className="operatorFieldRuntime__panelTitle">{t("forecast")}</h2></div><span className="operatorFieldRuntime__panelMeta">operator_field_twin_forecast_panel_v1</span></div>
        <p className="operatorFieldRuntime__stubLead">forecast_window_v1</p>
