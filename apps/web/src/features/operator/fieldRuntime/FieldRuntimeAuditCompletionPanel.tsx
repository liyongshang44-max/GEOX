...
export default function FieldRuntimeAuditCompletionPanel({ audit }: { audit: FieldRuntimeAuditViewModel }): React.ReactElement {
  ...
  const rows = [["H60-D Overview / State", audit.completionSummary.h60D], ["H60-E Evidence", audit.completionSummary.h60E], ["H60-F Forecast", audit.completionSummary.h60F], ["H60-G Scenario", audit.completionSummary.h60G], ["H60-H Residual / Verification", audit.completionSummary.h60H], ["H60-I Calibration", audit.completionSummary.h60I], ["Health", "H62"], ["Audit", "H60-K"]];
