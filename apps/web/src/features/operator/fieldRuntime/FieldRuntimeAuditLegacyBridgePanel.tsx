...
export default function FieldRuntimeAuditLegacyBridgePanel({ audit }: { audit: FieldRuntimeAuditViewModel }): React.ReactElement {
  ...
  return <article className="operatorFieldRuntime__panel operatorFieldRuntime__auditLegacyBridge" data-h60k-panel="audit-legacy-bridge">
    <div className="operatorFieldRuntime__panelHeader"><div><p className="operatorFieldRuntime__eyebrow">{t("audit")}</p><h2 className="operatorFieldRuntime__panelTitle">{t("auditLegacyBridge")}</h2></div><span className="operatorFieldRuntime__panelMeta" data-locale-neutral="true">{audit.legacyRouteFamily}</span></div>
