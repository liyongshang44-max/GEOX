...
// Purpose: render the Field Runtime product shell, boundary banner, tabs, migrated read-only content through H60-H, and static future-tab body.
// Boundary: this layout owns presentation only; Calibration, Health, and Audit migrate later.
...
function renderTabContent(
  ...
  residualLoadState: FieldRuntimeResidualLoadState | undefined,
): React.ReactElement {
...
export default function FieldRuntimeLayout({ viewModel, workspaceLoadState, evidenceLoadState, forecastLoadState, scenarioLoadState, residualLoadState }: FieldRuntimeLayoutProps): React.ReactElement {
  return (
    <main className="operatorFieldRuntime" data-h60c="field-runtime-layout-tabs" data-h60d="field-runtime-overview-state" data-h60e="field-runtime-evidence-tab" data-h60f="field-runtime-forecast-tab" data-h60g="field-runtime-scenario-readonly-split" data-h60h="field-runtime-residual-verification-tab" data-field-runtime-route={viewModel.routeKey}>
      <header className="operatorFieldRuntime__header" aria-label="Field Runtime header">
        <div>
          <p className="operatorFieldRuntime__eyebrow">H60-H Field Runtime Residual / Verification Tab</p>
      ...
      <section className="operatorFieldRuntime__tabPanel" aria-label="Field Runtime tab panel">
        {renderTabContent(viewModel, workspaceLoadState, evidenceLoadState, forecastLoadState, scenarioLoadState, residualLoadState)}
      </section>
    </main>
  );
}
