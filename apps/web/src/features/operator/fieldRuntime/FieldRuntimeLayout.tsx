...
// Purpose: render the Field Runtime product shell, boundary banner, tabs, migrated read-only content through H60-I, and static future-tab body.
// Boundary: this layout owns presentation only; Health and Audit migrate later.
...
function renderTabContent(viewModel: FieldRuntimeViewModel, workspaceLoadState: FieldRuntimeWorkspaceLoadState | undefined, evidenceLoadState: FieldRuntimeEvidenceLoadState | undefined, forecastLoadState: FieldRuntimeForecastLoadState | undefined, scenarioLoadState: FieldRuntimeScenarioLoadState | undefined, residualLoadState: FieldRuntimeResidualLoadState | undefined, calibrationLoadState: FieldRuntimeCalibrationLoadState | undefined): React.ReactElement {
...
export default function FieldRuntimeLayout({ viewModel, workspaceLoadState, evidenceLoadState, forecastLoadState, scenarioLoadState, residualLoadState, calibrationLoadState }: FieldRuntimeLayoutProps): React.ReactElement {
  return (
    <main className="operatorFieldRuntime" data-h60c="field-runtime-layout-tabs" data-h60d="field-runtime-overview-state" data-h60e="field-runtime-evidence-tab" data-h60f="field-runtime-forecast-tab" data-h60g="field-runtime-scenario-readonly-split" data-h60h="field-runtime-residual-verification-tab" data-h60i="field-runtime-calibration-tab" data-field-runtime-route={viewModel.routeKey}>
      ...
      <section className="operatorFieldRuntime__tabPanel" aria-label="Field Runtime tab panel">{renderTabContent(viewModel, workspaceLoadState, evidenceLoadState, forecastLoadState, scenarioLoadState, residualLoadState, calibrationLoadState)}</section>
    </main>
  );
}
