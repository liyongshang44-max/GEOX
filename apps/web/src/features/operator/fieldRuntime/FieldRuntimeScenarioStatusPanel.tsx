...
export default function FieldRuntimeScenarioStatusPanel({ scenario }: { scenario: FieldRuntimeScenarioViewModel }): React.ReactElement {
  ...
  return <article className="operatorFieldRuntime__panel operatorFieldRuntime__scenarioStatus" data-h60g-panel="scenario-status">
    ...
    <div className="operatorFieldRuntime__metricGrid">
      <section className="operatorFieldRuntime__metricCard"><p className="operatorFieldRuntime__panelMeta">{t("status")}</p><strong>{compare.status}</strong></section>
      ...
      <section className="operatorFieldRuntime__metricCard"><p className="operatorFieldRuntime__panelMeta">{c(COPY.reason)}</p><strong>{compare.unavailableReason}</strong></section>
      <section className="operatorFieldRuntime__metricCard"><p className="operatorFieldRuntime__panelMeta">{c(COPY.setId)}</p><strong>{compare.scenarioSetId}</strong></section>
    </div>
  </article>;
}
