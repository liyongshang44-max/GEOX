...
export function DashboardExportBlocks({ vm }: { vm: CustomerDashboardPageVm }): React.ReactElement {
  ...
  return (
    <div className="customerCompactReport">
      <section className="customerCard"><h2 className="customerCardTitle">概览</h2><p className="customerSpacingTopSm">{safeExportText(vm.summaryText ?? "客户经营总览", "客户经营总览")}</p></section>
