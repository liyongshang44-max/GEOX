      ...
      <section className="card" style={{ marginTop: 16 }}>
        ...
        <div className="decisionList" style={{ marginTop: 12 }}>
          <div className="decisionItemStatic">
            ...
            <div className="decisionItemMeta">{recentOperationEffect.effective}</div>
          </div>
          <div className="decisionItemStatic">
            <div className="decisionItemTitle">⚠️ 偏差作业</div>
            <div className="decisionItemMeta">{recentOperationEffect.deviation}</div>
          </div>
          <div className="decisionItemStatic">
            <div className="decisionItemTitle">❌ 无效执行</div>
            <div className="decisionItemMeta">{recentOperationEffect.invalid}</div>
          </div>
        </div>
      </section>
