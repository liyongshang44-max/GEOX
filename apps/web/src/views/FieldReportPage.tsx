    ...
    <div className="customerReportCanvas">
      <div className="customerReportSheet customerPageGapMd fieldReportLayout">
        ...
        <section className="fieldGrid fieldGrid3">
          ...
          <article className="customerCard"><h3 className="customerCardTitle">统一证据视图</h3><EvidenceTrustLegend vm={evidenceVm} /><EvidenceTrustBadge vm={evidenceVm} /><EvidenceRefList vm={evidenceVm} /><EvidenceGapPanel vm={evidenceVm} /></article>
