...
exports.JudgeConfigPatchRejected = void 0;
exports.computeEffectiveConfigHash = computeEffectiveConfigHash;
exports.validatePatchEnvelopeStrict = validatePatchEnvelopeStrict;
exports.validatePatchStrict = validatePatchStrict;
exports.applyPatch = applyPatch;
const util_1 = require("../util");
class JudgeConfigPatchRejected extends Error {
...
exports.JudgeConfigPatchRejected = JudgeConfigPatchRejected;
function isObj(x) {
...
function computeEffectiveConfigHash(cfg) {
