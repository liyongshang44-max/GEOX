#!/usr/bin/env node
/**
 * Generate Judge compatibility artifacts from default.json (Single Source of Truth).
 *
 * Outputs:
...
// Source of truth: config/judge/default.json
...
This repo uses **config/judge/default.json** as the **Single Source of Truth**. `config/judge/ruleset_v1.json` is a retained legacy compatibility snapshot and is not an active authority source.
