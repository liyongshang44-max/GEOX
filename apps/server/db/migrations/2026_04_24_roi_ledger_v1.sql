CREATE TABLE IF NOT EXISTS roi_ledger_v1 (
  ...
  baseline_type text NOT NULL DEFAULT 'DEFAULT_ASSUMPTION',
  baseline_value numeric NULL,
  planned_value numeric NULL,
  actual_value numeric NULL,
  delta_value numeric NULL,
  unit text NULL,
  estimated_money_value numeric NULL,
  currency text NULL,
  source_skill_id text NULL,
  skill_trace_ref text NULL,
  field_memory_refs jsonb NOT NULL DEFAULT '[]'::jsonb,
  value_kind text NOT NULL DEFAULT 'ASSUMPTION_BASED',
