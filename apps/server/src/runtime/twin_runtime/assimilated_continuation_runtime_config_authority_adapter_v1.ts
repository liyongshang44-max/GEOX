...
export type McftCap03PredecessorLockV1 = {
  status: "COMPLETE";
...
export function compileAssimilatedContinuationRuntimeConfigFromAuthorityV1(input: {
  predecessor_lock: McftCap03PredecessorLockV1;
  ...
  return compileAssimilatedContinuationRuntimeConfigV1({
