...
function externalRuntimePayloadV1(config: CanonicalObjectEnvelopeV1, logicalTime: string): ExternalFormalRuntimeConfigPayloadV1 {
...
function normalizeCompatibilityForcingRuntimeAuthorityV1(
...
export function executeExternalFormalCap04CandidateV1(
  ...
  const compatibilityForecastMath = executeCap04Pure72hForecastMathV1({
    source_posterior: {
      ...
      logical_time: logicalTime,
      computation_basis: stateDecimalBasisV1(sourceState),
    },
  ...
  const normalizedCompatibilityForecastMath = normalizeCompatibilityForcingRuntimeAuthorityV1(
