...
import {
  ...
  MCFT_CAP_02_CONTINUATION_COVARIANCE_POLICY_V1,
...
function freezePayloadV1(input: CompileContinuationRuntimeConfigInputV1): ContinuationRuntimeConfigSemanticPayloadV1 {
  return {
    ...
    crop_stage_context: {
      ...
      context_ref: requireStringV1(input.crop_stage_context_ref, "CROP_STAGE_CONTEXT_REF_REQUIRED"),
      context_hash: requireStringV1(input.crop_stage_context_hash, "CROP_STAGE_CONTEXT_HASH_REQUIRED"),
      resolution_policy_id: MCFT_CAP_02_CONTINUATION_ROOT_ZONE_POLICY_ID_V1,
    },
    dynamics_model: {
      model_component_ref: requireStringV1(input.dynamics_model_component_ref, "DYNAMICS_MODEL_COMPONENT_REF_REQUIRED"),
      model_id: MCFT_CAP_02_CONTINUATION_MODEL_ID_V1,
      model_version: 1,
      step_duration: "PT1H",
    },
    soil_hydraulic_snapshot: {
      source_config_ref: requireStringV1(input.soil_hydraulic_source_config_ref, "SOIL_HYDRAULIC_SOURCE_CONFIG_REF_REQUIRED"),
      source_config_hash: requireStringV1(input.soil_hydraulic_source_config_hash, "SOIL_HYDRAULIC_SOURCE_CONFIG_HASH_REQUIRED"),
    ...
    soil_root_zone_config_refs: requireArrayV1([input.soil_root_zone_config_ref], "SOIL_ROOT_ZONE_CONFIG_REFS_REQUIRED"),
    model_component_refs: requireArrayV1(input.model_component_refs, "MODEL_COMPONENT_REFS_REQUIRED"),
  };
}
