...
export const EXTERNAL_FORMAL_V4_AM19_RUNNER_ID_V2 = "MCFT_CAP09_EXTERNAL_FORMAL_V4_AM19_RUNNER_V2" as const;
export const EXTERNAL_FORMAL_V4_AM19_RUNNER_WATERMARK_ID_V2 = "PROVIDER_AVAILABILITY_WATERMARK_V1" as const;

type MaterializedExternalFormalA18CropContextSuccessorV2 =
  MaterializedExternalFormalA18CropContextV4;

export type ExternalFormalV4Am19ManifestSlotPinV2 = ExternalFormalV3Amendment19ManifestSlotPinV1 & {
  parent_runtime_config_ref: string;
  parent_runtime_config_hash: string;
  crop_stage_context_materialization_hash: string;
};

export type ExternalFormalV4Am19WindowManifestV2 = {
  manifest_ref: string;
  ...
  slots: readonly ExternalFormalV4Am19ManifestSlotPinV2[];
};

export interface ExternalFormalV4Am19CropContextMaterializerPortV2 {
  materialize(input: {
    logical_time: string;
    expected_identity_hash: string;
  }): Promise<MaterializedExternalFormalA18CropContextSuccessorV2> | MaterializedExternalFormalA18CropContextSuccessorV2;
}
...
export type ExecuteExternalFormalV3Am19RunnerResultV1 =
  | {
      runner_id: typeof EXTERNAL_FORMAL_V4_AM19_RUNNER_ID_V2;
      status: "NO_DUE_SLOT";
...
function computeMaterializationHashV2(materialized: MaterializedExternalFormalA18CropContextSuccessorV2): string {
...
function exactRuntimeConfigPreclaimV1(config: CanonicalObjectEnvelopeV1, slot: ExternalFormalV4Am19ManifestSlotPinV2): void {
...
export class ExternalFormalV4Amendment19RunnerV2 {
  constructor(
    private readonly manifest: ExternalFormalV4Am19WindowManifestV2,
    private readonly scheduler: SchedulerPortSubsetV1,
    private readonly runtimeConfigRepository: RuntimeConfigReadPortV1,
    private readonly cropContextMaterializer: ExternalFormalV4Am19CropContextMaterializerPortV2,
  ...
  async executeOneDueSlot(input: ExecuteExternalFormalV3Am19RunnerInputV1): Promise<ExecuteExternalFormalV3Am19RunnerResultV1> {
    ...
    if (due.length === 0) {
      return { runner_id: EXTERNAL_FORMAL_V4_AM19_RUNNER_ID_V2, status: "NO_DUE_SLOT", claim_attempted: false, provider_request_count: 0, r2_request_count: 0 };
    }
    ...
    if (!runtimeConfig) {
      return { runner_id: EXTERNAL_FORMAL_V4_AM19_RUNNER_ID_V2, status: "NOT_READY_PRECLAIM", slot_id: slot.slot_id, logical_time: slot.logical_time, reason: "RUNTIME_CONFIG_MISSING", detail: slot.runtime_config_ref, claim_attempted: false, provider_request_count: 0, r2_request_count: 0 };
    }
    try {
      exactRuntimeConfigPreclaimV1(runtimeConfig, slot);
    } catch (error) {
      return { runner_id: EXTERNAL_FORMAL_V4_AM19_RUNNER_ID_V2, status: "NOT_READY_PRECLAIM", slot_id: slot.slot_id, logical_time: slot.logical_time, reason: "RUNTIME_CONFIG_PIN_MISMATCH", detail: errorDetailV1(error), claim_attempted: false, provider_request_count: 0, r2_request_count: 0 };
    }

    let materialized: MaterializedExternalFormalA18CropContextSuccessorV2;
    try {
      ...
      const independentMaterializationHash = computeMaterializationHashV2(materialized);
      ...
      return { runner_id: EXTERNAL_FORMAL_V4_AM19_RUNNER_ID_V2, status: "NOT_READY_PRECLAIM", slot_id: slot.slot_id, logical_time: slot.logical_time, reason: "CROP_CONTEXT_BINDING_FAILED", detail: errorDetailV1(error), claim_attempted: false, provider_request_count: 0, r2_request_count: 0 };
    }
    ...
    try {
      ...
      return { runner_id: EXTERNAL_FORMAL_V4_AM19_RUNNER_ID_V2, status: "NOT_READY_PRECLAIM", slot_id: slot.slot_id, logical_time: slot.logical_time, reason: "EVIDENCE_PRECHECK_FAILED", detail: errorDetailV1(error), claim_attempted: false, provider_request_count: 0, r2_request_count: 0 };
    }
    ...
    try {
      ...
      await this.scheduler.recordTerminalResult({
        ...
        result: {
          ...
          health_ref: `${EXTERNAL_FORMAL_V4_AM19_RUNNER_ID_V2}:${slot.slot_id}:${tickResult.runtime_health}`,
          terminal_at: observerStartedAt,
        },
      });
      return {
        runner_id: EXTERNAL_FORMAL_V4_AM19_RUNNER_ID_V2,
      ...
      await this.scheduler.recordTerminalResult({
        ...
        result: {
          ...
          state: "FAILED",
          tick_ref: null,
          health_ref: `${EXTERNAL_FORMAL_V4_AM19_RUNNER_ID_V2}:${slot.slot_id}:${blocked ? "BLOCKED_NO_CAUSAL_FORCING" : "FAILED"}`,
          terminal_at: observerStartedAt,
        },
      });
      return {
