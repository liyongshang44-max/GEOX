...
export const A0_BLOCKED_FORECAST_REASON_CODES_V1 = [
...
function nextHourIsoV1(logicalTime: string): string {
...
export function buildA0RecordSetV1(input: BuildA0RecordSetInputV1): A0RecordSetV1 {
  ...
  if (!input.evidence_window.frozen) throw new Error("FROZEN_EVIDENCE_WINDOW_REQUIRED");
  ...
  const observationValue = input.evidence_window.assimilation_observation.canonical_payload.value;
  const posterior = buildRootZoneWaterPosteriorV1({
    observation_fraction: observationValue,
  ...
  const memberKey = (objectType: string) => deriveSemanticObjectIdV1("a0_member_key", {
    a0_idempotency_key: identity.a0_idempotency_key,
    object_type: objectType,
  });
  const sourceRefs = [...new Set([realityBindingRef, ...input.evidence_window.selected_source_refs])].sort();
  ...
  const nextTickLogicalTime = nextHourIsoV1(input.logical_time);
  const forecastReasons = [...A0_BLOCKED_FORECAST_REASON_CODES_V1];
  ...
  const members: CanonicalObjectEnvelopeV1[] = [
    commonMemberV1({
      type: "twin_runtime_lineage_v1",
      object_id: ids.twin_runtime_lineage_v1,
      idempotency_key: memberKey("twin_runtime_lineage_v1"),
      scope: input.scope,
      logical_time: input.logical_time,
      created_at: input.created_at,
      source_refs: [realityBindingRef],
      evidence_refs: [],
    ...
    commonMemberV1({
      ...
      object_id: ids.twin_evidence_window_v1,
      idempotency_key: memberKey("twin_evidence_window_v1"),
      scope: input.scope,
      logical_time: input.logical_time,
      created_at: input.created_at,
    ...
    commonMemberV1({
      type: "twin_state_transition_v1",
      object_id: ids.twin_state_transition_v1,
      idempotency_key: memberKey("twin_state_transition_v1"),
      scope: input.scope,
      logical_time: input.logical_time,
      created_at: input.created_at,
      source_refs: sourceRefs,
    ...
    commonMemberV1({
      ...
      object_id: ids.twin_assimilation_update_v1,
      idempotency_key: memberKey("twin_assimilation_update_v1"),
      scope: input.scope,
      logical_time: input.logical_time,
      created_at: input.created_at,
      source_refs: sourceRefs,
    ...
    commonMemberV1({
      ...
      object_id: ids.twin_state_estimate_v1,
      idempotency_key: memberKey("twin_state_estimate_v1"),
      scope: input.scope,
      logical_time: input.logical_time,
      created_at: input.created_at,
      source_refs: sourceRefs,
      evidence_refs: evidenceRefs,
      runtime_config: input.runtime_config,
      limitations: [...commonLimitations, ...posterior.limitations],
      lineage_id: lineageId,
      revision_id: revisionId,
      payload: {
    ...
    commonMemberV1({
      ...
      object_id: ids.twin_forecast_run_v1,
      idempotency_key: memberKey("twin_forecast_run_v1"),
      scope: input.scope,
      logical_time: input.logical_time,
      created_at: input.created_at,
      source_refs: sourceRefs,
    ...
    commonMemberV1({
      type: "twin_runtime_tick_v1",
      object_id: ids.twin_runtime_tick_v1,
      idempotency_key: memberKey("twin_runtime_tick_v1"),
      scope: input.scope,
      logical_time: input.logical_time,
      created_at: input.created_at,
      source_refs: sourceRefs,
    ...
    commonMemberV1({
      ...
      object_id: ids.twin_runtime_checkpoint_v1,
      idempotency_key: memberKey("twin_runtime_checkpoint_v1"),
      scope: input.scope,
      logical_time: input.logical_time,
      created_at: input.created_at,
      source_refs: sourceRefs,
    ...
    commonMemberV1({
      type: "twin_runtime_health_v1",
      object_id: ids.twin_runtime_health_v1,
      idempotency_key: memberKey("twin_runtime_health_v1"),
      scope: input.scope,
      logical_time: input.logical_time,
      created_at: input.created_at,
      source_refs: sourceRefs,
