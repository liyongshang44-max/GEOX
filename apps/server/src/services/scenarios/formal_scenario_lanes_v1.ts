...
const DEFINITIONS: readonly FormalScenarioLaneDefinitionV1[] = [
  { scenario_type: "FORMAL_IRRIGATION", lane: "positive", label: "Formal irrigation positive closed loop", release_gate: true, flight_table_visible: true },
  { scenario_type: "FORMAL_IRRIGATION", lane: "negative", label: "Formal irrigation negative evidence lanes", release_gate: true, flight_table_visible: true },
  { scenario_type: "DEVICE_ANOMALY", lane: "anomaly", label: "Device anomaly and offline fail-safe lane", release_gate: true, flight_table_visible: true },
  { scenario_type: "FORMAL_VARIABLE_OPERATION", lane: "positive", label: "Formal variable operation positive lane", release_gate: true, flight_table_visible: true },
  { scenario_type: "FORMAL_VARIABLE_OPERATION", lane: "partial", label: "Formal variable operation partial rollup lane", release_gate: true, flight_table_visible: true },
  { scenario_type: "FORMAL_VARIABLE_OPERATION", lane: "negative", label: "Formal variable operation negative zone lanes", release_gate: true, flight_table_visible: true },
] as const;
