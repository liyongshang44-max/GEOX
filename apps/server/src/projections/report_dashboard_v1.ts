...
function buildFieldValueSummary(reports: OperationReportV1[]): RoiSummaryTrustV1 {
  ...
  return {
    ...
    customer_value_text: hasValue ? `可信价值记录 ${trustedItems.length} 条` : "暂无可作为客户正式价值结论的记录",
  };
}
