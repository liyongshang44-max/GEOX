...
implements Cap08S3CompletionAuthorityPairPortV1 {
  ...
  private async inspectWithClientV1(
    ...
    if (!genericRow && !semanticRow) {
      ...
      if (genericInspection.disposition !== "NOT_STARTED"
        && genericInspection.disposition !== "RESUMABLE") {
        throw new Error(
          `CAP08_S3_COMPLETION_GRAPH_NOT_EXECUTABLE:${genericInspection.disposition}`,
        );
      }
      return {
