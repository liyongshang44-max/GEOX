...
export type AssimilatedContinuationAggregateIdentityInputV2 = {
...
export type AssimilatedContinuationRecordSetV2 = ContinuationOperationIdentityV1 & {
  record_set_contract_id: typeof ASSIMILATED_CONTINUATION_RECORD_SET_CONTRACT_ID_V2;
  aggregate_identity_input: AssimilatedContinuationAggregateIdentityInputV2;
...
export function computeAssimilatedContinuationRecordSetDeterminismHashV2(
  input: AssimilatedContinuationAggregateIdentityInputV2,
): string {
  if (input.record_set_contract_id !== ASSIMILATED_CONTINUATION_RECORD_SET_CONTRACT_ID_V2) {
...
export function buildAssimilatedContinuationRecordSetIdentityV2(input: {
  continuation_operation_key: ContinuationOperationKeyV1;
  aggregate_identity_input: Omit<AssimilatedContinuationAggregateIdentityInputV2, "continuation_operation_key" | "record_set_contract_id">;
}): Omit<AssimilatedContinuationRecordSetV2, "members"> {
  const operationIdentity = deriveContinuationOperationIdentityV1(input.continuation_operation_key);
  const aggregateIdentityInput: AssimilatedContinuationAggregateIdentityInputV2 = {
  ...
  return {
    ...
    continuation_record_set_determinism_hash:
      computeAssimilatedContinuationRecordSetDeterminismHashV2(aggregateIdentityInput),
  };
}
