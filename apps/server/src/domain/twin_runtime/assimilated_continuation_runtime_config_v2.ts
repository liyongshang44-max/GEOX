...
export const ASSIMILATED_CONTINUATION_CONFIG_PURPOSE_V2 =
  "HOURLY_DYNAMICS_WITH_OBSERVATION_ASSIMILATION_V2" as const;
export const ASSIMILATED_CONTINUATION_OBSERVATION_SELECTOR_ID_V2 =
...
export type AssimilatedContinuationRuntimeConfigPayloadV2 = {
  config_purpose: typeof ASSIMILATED_CONTINUATION_CONFIG_PURPOSE_V2;
  ...
  record_set_contract_id: typeof ASSIMILATED_CONTINUATION_RECORD_SET_CONTRACT_ID_V2;
  ...
  observation_assimilation: {
    ...
    observation_selector_id: typeof ASSIMILATED_CONTINUATION_OBSERVATION_SELECTOR_ID_V2;
...
export type CompileAssimilatedContinuationRuntimeConfigInputV2 = {
...
export function validateAssimilatedContinuationRuntimeConfigPayloadV2(
  value: unknown,
): asserts value is AssimilatedContinuationRuntimeConfigPayloadV2 {
  const payload = requiredRecordV1(value, "ASSIMILATED_RUNTIME_CONFIG_PAYLOAD_REQUIRED");
  exactV1(payload.config_purpose, ASSIMILATED_CONTINUATION_CONFIG_PURPOSE_V2, "ASSIMILATED_CONFIG_PURPOSE_MISMATCH");
  exactV1(payload.config_selection_mode, CONTINUATION_CONFIG_SELECTION_MODE_V1, "ASSIMILATED_CONFIG_SELECTION_MODE_MISMATCH");
  exactV1(payload.record_set_contract_id, ASSIMILATED_CONTINUATION_RECORD_SET_CONTRACT_ID_V2, "ASSIMILATED_CONFIG_RECORD_SET_CONTRACT_MISMATCH");
  for (const field of [
  ...
  exactV1(assimilation.observation_selector_id, ASSIMILATED_CONTINUATION_OBSERVATION_SELECTOR_ID_V2, "ASSIMILATED_SELECTOR_MISMATCH");
...
export function compileAssimilatedContinuationRuntimeConfigV2(
  input: CompileAssimilatedContinuationRuntimeConfigInputV2,
): CanonicalObjectEnvelopeV1 {
  const payload: AssimilatedContinuationRuntimeConfigPayloadV2 = {
    config_purpose: ASSIMILATED_CONTINUATION_CONFIG_PURPOSE_V2,
    ...
    observation_assimilation: {
      ...
      observation_selector_id: ASSIMILATED_CONTINUATION_OBSERVATION_SELECTOR_ID_V2,
  ...
  validateAssimilatedContinuationRuntimeConfigPayloadV2(payload);
