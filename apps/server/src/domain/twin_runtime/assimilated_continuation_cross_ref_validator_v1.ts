...
import {
  ASSIMILATED_CONTINUATION_EVIDENCE_WINDOW_CONTRACT_ID_V1,
...
function validateEvidenceClassificationsV1(input: {
  ...
  assimilation: AssimilatedContinuationUpdatePayloadV1;
...
function expectedHealthStatusV1(payload: AssimilatedContinuationUpdatePayloadV1): string {
...
export function validateAssimilatedContinuationCrossReferencesV1(
  recordSet: AssimilatedContinuationRecordSetV1,
): void {
  validateAssimilatedContinuationRecordSetV1(recordSet);
  ...
  if (tick.payload.record_set_contract_id !== ASSIMILATED_CONTINUATION_RECORD_SET_CONTRACT_ID_V1) {
