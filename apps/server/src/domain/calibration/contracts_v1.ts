...
export const CAP06_WINDOW_HASH_SEMANTICS_V1 = "ORDERED_RESIDUAL_REF_MEMBERSHIP_ONLY_V1" as const;
export const CAP06_HOLDOUT_PURPOSE_V1 = "HIGH_EXCESS_STRESS_HOLDOUT_ONLY" as const;
export const CAP06_HOLDOUT_GENERALIZATION_CLAIM_V1 = "NOT_ESTABLISHED" as const;
