...
export const ROLE_SCOPE_MATRIX_V1: Record<AuthRole, (AoActScopeV0 | "*")[]> = {
  ...
  operator: ["operation.plan.create","recommendation.approval_request","action.read","action.task.create","action.task.dispatch","action.receipt.submit","judge.execution.write","acceptance.evaluate","field.zone.read","skill.read","skill.run.write","telemetry.read","telemetry.write","inspection.read","inspection.write"],
