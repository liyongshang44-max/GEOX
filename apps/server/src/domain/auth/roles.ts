...
export const ROLE_SCOPE_MATRIX_V1: Record<AuthRole, (AoActScopeV0 | "*")[]> = {
  ...
  executor: ["action.read","action.task.dispatch","action.receipt.submit","ao_act.receipt.write","evidence.artifact.write","field.zone.read","skill.run.write","telemetry.write"],
