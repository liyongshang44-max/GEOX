const SALES_CRITICAL_OPERATION_GOVERNANCE_V1 = {
  ...
  "/api/v1/actions/receipt/from-task": { post: { operationId: "submitAoActReceiptFromTaskV1", owner: "executor-service / act-service", audience: "executor/operator", boundary: "official", auth_scope: "action.receipt.submit", security: "bearerAuth", error_model: "GEOX_STANDARD_ERROR_ENVELOPE_V2", contract_ref: "docs/contracts/v2/AO_ACT_AO_SENSE_BOUNDARY_V1.md", gate_maturity: "release_gate_candidate" } },
