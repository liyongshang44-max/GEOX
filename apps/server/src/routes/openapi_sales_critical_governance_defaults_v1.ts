const SALES_CRITICAL_OPERATION_GOVERNANCE_V1 = {
  ...
  "/api/v1/evidence-export/jobs": { post: { operationId: "createEvidenceExportJobV1", owner: "facts-service", audience: "operator", boundary: "official", auth_scope: "evidence_export.write or evidence_export.*", error_model: "GEOX_STANDARD_ERROR_ENVELOPE_V2", contract_ref: "docs/contracts/v2/EVIDENCE_EXPORT_S3_V1.md", gate_maturity: "release_gate_candidate" } },
