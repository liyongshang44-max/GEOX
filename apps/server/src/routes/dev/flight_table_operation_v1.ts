...
import { runFlightTableOperationAoActReceiptV1 } from "../../services/flight_table/flight_table_operation_v1.js";
...
export function registerFlightTableOperationRoutesV1(app: FastifyInstance, pool: Pool): void {
  app.post("/api/v1/dev/flight-table/runs/:runId/operation/run", async (req, reply) => {
    ...
    try {
      ...
      const result = await runFlightTableOperationAoActReceiptV1({
        pool,
        run,
