...
const scope = {
  ...
  properties: Object.fromEntries(
    ["tenant_id", "project_id", "group_id", "field_id", "season_id", "zone_id"].map((name) => [
      name,
...
const scopeParameters = [
  ...
  ...["tenant_id", "project_id", "group_id", "season_id", "zone_id"].map((name) => ({
    name,
    in: "query",
    required: true,
...
const slotState = {
  enum: ["CLAIMED", "RUNNING", "COMPLETED", "DEGRADED", "FAILED", "NOT_MATERIALIZED"],
} as const;
  ...
  Pfe14Mcft09OperationalSummaryV1: {
    ...
    properties: {
      ...
      scheduler_summary: {
        ...
        properties: {
          scheduler_status: { enum: ["WAITING", "RUNNING", "COMPLETED", "NOT_ESTABLISHED"] },
          latest_completed_slot: nullableInstant,
          latest_tick_ref: { type: ["string", "null"] },
          latest_tick_status: { enum: ["COMPLETED", "DEGRADED", "FAILED", null] },
          latest_tick_started_at: { type: "null" },
          latest_tick_completed_at: nullableInstant,
          next_target_slot: nullableInstant,
          next_target_at: nullableInstant,
          scheduler_lag_ms: { type: ["integer", "null"], minimum: 0 },
        },
      },
      evidence_availability: {
        type: "object",
        ...
        properties: {
            ...
            anyOf: [
              {
                type: "object",
                additionalProperties: false,
                required: ["slot_id", "logical_time"],
                properties: {
                  slot_id: { pattern: "^O(0[0-9]|1[0-9]|2[0-3])$" },
          ...
          latest_evidence_observed_at: nullableInstant,
          latest_evidence_ingested_at: nullableInstant,
          evidence_age_ms: { type: ["integer", "null"], minimum: 0 },
          freshness_status: { enum: ["FRESH", "STALE", "MISSING", "UNKNOWN"] },
          freshness_threshold_ms: { type: "integer", minimum: 1 },
          coverage_ratio: { type: ["number", "null"], minimum: 0, maximum: 1 },
          maximum_gap_ms: { type: ["integer", "null"], minimum: 0 },
          future_excluded_count: { type: ["integer", "null"], minimum: 0 },
          late_evidence_count: { type: ["integer", "null"], minimum: 0 },
          out_of_order_count: { type: ["integer", "null"], minimum: 0 },
        },
      },
      operational_status: {
        type: "object",
      ...
      slot_window: {
        anyOf: [
          { type: "null" },
          {
            type: "object",
            additionalProperties: false,
            required: ["schedule_start_logical_time", "interval_seconds", "entries"],
            properties: {
              ...
              entries: {
                ...
                items: {
                  type: "object",
                  additionalProperties: false,
                  required: ["slot_id", "logical_time", "state", "tick_ref", "health_ref", "terminal_at"],
                  properties: {
                    slot_id: { pattern: "^O(0[0-9]|1[0-9]|2[0-3])$" },
                    logical_time: instant,
                    state: slotState,
                    tick_ref: { type: ["string", "null"] },
                    health_ref: { type: ["string", "null"] },
                    terminal_at: nullableInstant,
                  },
                },
              },
            },
      ...
      validation_summary: { type: "array", items: { type: "string" } },
      operational_content_hash: hash,
      response_instance_hash: hash,
    },
  },
} as const;
...
export const PFE14_MCFT09_OPERATIONAL_OPENAPI_PATHS_V1 = {
  "/api/v1/operator/twin/fields/{field_id}/runtime/operational-summary": {
    get: {
      ...
      responses: {
        "200": {
          description: "GET-only operational projection; not canonical Twin truth",
          content: {
            "application/json": {
              schema: { $ref: "#/components/schemas/Pfe14Mcft09OperationalSummaryV1" },
            },
          },
        },
        "400": { description: "Invalid exact-scope request" },
        "403": { description: "Exact scope forbidden" },
        "409": { description: "Operational or canonical read state inconsistent" },
        "503": { description: "Required read source unavailable" },
      },
    },
  },
} as const;
