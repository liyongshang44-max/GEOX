// OpenAPI overlay for the PFE-14 / MCFT-9 GET-only operational-summary candidate.
...
export const PFE14_MCFT09_OPERATIONAL_OPENAPI_SCHEMAS_V1 = {
  Pfe14Mcft09OperationalSummaryV1: {
    type: "object", additionalProperties: false,
    required: ["schema_version", "request_scope", "response_started_at", "scheduler_summary", "evidence_availability", "limitations", "validation_summary", "operational_content_hash", "response_instance_hash"],
    properties: {
...
export const PFE14_MCFT09_OPERATIONAL_OPENAPI_PATHS_V1 = {
  "/api/v1/operator/twin/fields/{field_id}/runtime/operational-summary": {
    get: {
      ...
      summary: "Read exact-scope MCFT-9 Scheduler Summary and Evidence Availability",
      ...
      responses: {
        "200": {
          ...
          content: { "application/json": { schema: { $ref: "#/components/schemas/Pfe14Mcft09OperationalSummaryV1" } } },
        },
        "400": { description: "Invalid exact-scope request" },
        "403": { description: "Exact scope forbidden" },
        "409": { description: "Operational scheduler state inconsistent" },
