      ...
      schemas: {
        ...
        EvidencePackSummaryV1: {
          ...
          required: [
            "status",
            "summary",
            "photos_logs_metrics_trace_summary",
            "evidence_count",
            "receipt_present",
            "acceptance_present"
          ],
          properties: {
            status: {
              type: "string",
              enum: ["READY", "PENDING", "MISSING", "FAILED"],
              description: "Backend evidence pack summary status."
            },
            summary: {
              type: "string",
              nullable: true,
              description: "Customer-safe evidence pack summary text."
            },
            photos_logs_metrics_trace_summary: {
              type: "string",
              nullable: true,
              description: "Customer-safe summary of photos, logs, metrics, and trace evidence."
            },
            ...
            manifest: {
              type: "string",
              nullable: true,
              description: "Customer-safe manifest label only. Must not expose local paths, S3/MinIO paths, or raw manifest JSON."
            },
            sha256: {
              type: "string",
              nullable: true,
              pattern: "^[a-fA-F0-9]{64}$",
              description: "Optional SHA-256 checksum when generated by backend."
            },
            download_url: {
              type: "string",
              nullable: true,
              description: "Optional customer-safe relative download URL. Must not expose internal object storage paths."
            },
            insufficient_reason: { type: "string", nullable: true },
        ...
        OperationReportV1: {
          ...
          properties: {
            ...
            evidence_pack_summary: { '$ref': "#/components/schemas/EvidencePackSummaryV1" },
            cost: {
              type: "object",
...
function applyP13OpenApiAlignment(spec: any) {
  ...
  Object.assign(schemas, {
    ...
    OperationDetailResponse: { type: "object", properties: { ok: { type: "boolean" }, item: { type: ["object", "null"], properties: { operation_id: { type: ["string", "null"] }, operation_plan_id: { type: ["string", "null"] }, recommendation_id: { type: ["string", "null"] }, field_id: { type: ["string", "null"] }, device_id: { type: ["string", "null"] }, action_type: { type: ["string", "null"] }, final_status: { type: ["string", "null"] }, title: { type: ["string", "null"] }, expected_effect: { type: ["string", "null"] }, report_json: { type: ["object", "null"], properties: { type: { type: ["string", "null"] }, summary: { type: ["string", "null"] }, root_cause: { type: ["string", "null"] }, risk: { type: ["string", "null"] }, recommendation: { type: ["string", "null"] }, evidence_refs: { type: "array", items: { type: "string" } }, roi_ledger: { type: ["object", "null"], properties: { water_saved: { type: "array", items: { type: "object", additionalProperties: true } }, labor_saved: { type: "array", items: { type: "object", additionalProperties: true } }, early_warning_lead_time: { type: "array", items: { type: "object", additionalProperties: true } }, first_pass_acceptance_rate: { type: "array", items: { type: "object", additionalProperties: true } }, low_confidence_items: { type: "array", items: { type: "object", additionalProperties: true } } }, additionalProperties: false } }, additionalProperties: false } }, additionalProperties: false } }, required: ["ok", "item"], additionalProperties: false },
  ...
  Object.assign(spec.paths, {
    ...
    "/api/v1/actions/receipt/from-task": { post: { tags: ["operations"], summary: "Submit AO-ACT receipt v1 from task", security: [{ bearerAuth: [] }], "x-auth-scope": "action.receipt.submit", "x-audience": "executor/operator", "x-boundary": "official", "x-owner": "executor-service / act-service", requestBody: { required: true, content: { "application/json": { schema: { type: "object" } } } }, responses: { "200": jsonResponse({ type: "object" }, "AO-ACT receipt v1 recorded") } } },
    ...
    "/api/v1/acceptance/from-evidence-artifacts": { post: { tags: ["operations"], summary: "Create acceptance result from formal evidence artifacts", security: [{ bearerAuth: [] }], requestBody: { required: true, content: { "application/json": { schema: ref("GenericOkResponse") } } }, responses: { "200": jsonResponse(ref("GenericOkResponse"), "Acceptance result recorded"), "400": jsonResponse(ref("GenericOkResponse"), "Invalid input"), "401": jsonResponse(ref("GenericOkResponse"), "Missing or invalid auth"), "403": jsonResponse(ref("GenericOkResponse"), "Forbidden"), "404": jsonResponse(ref("GenericOkResponse"), "Missing source record or evidence artifact"), "409": jsonResponse(ref("GenericOkResponse"), "Duplicate idempotency key"), "422": jsonResponse(ref("GenericOkResponse"), "Acceptance rejected") }, "x-geox-governance": { owner: "acceptance-service / evidence-service", audience: "operator", boundary: "official", auth_scope: "acceptance.evaluate", error_model: "GEOX_STANDARD_ERROR_ENVELOPE_V2", contract_ref: "docs/contracts/v2/EVIDENCE_AND_ACCEPTANCE_CONTRACT_V2.md", gate_maturity: "ci_enforced" } } },
    "/api/v1/water-response/verify-from-acceptance": { post: { tags: ["operations"], summary: "Verify post-execution root-zone water response from accepted execution", security: [{ bearerAuth: [] }], requestBody: { required: true, content: { "application/json": { schema: ref("GenericOkResponse") } } }, responses: { "200": jsonResponse(ref("GenericOkResponse"), "Water response verification recorded"), "400": jsonResponse(ref("GenericOkResponse"), "Invalid input"), "401": jsonResponse(ref("GenericOkResponse"), "Missing or invalid auth"), "403": jsonResponse(ref("GenericOkResponse"), "Forbidden"), "404": jsonResponse(ref("GenericOkResponse"), "Missing source record"), "409": jsonResponse(ref("GenericOkResponse"), "Duplicate idempotency key"), "422": jsonResponse(ref("GenericOkResponse"), "Verification rejected") }, "x-geox-governance": { owner: "water-response-service / acceptance-service", audience: "operator/agronomist", boundary: "official", auth_scope: "water_response.verify", error_model: "GEOX_STANDARD_ERROR_ENVELOPE_V2", contract_ref: "docs/contracts/v2/EVIDENCE_AND_ACCEPTANCE_CONTRACT_V2.md", gate_maturity: "ci_enforced" } } },
    "/api/v1/evidence-artifacts/from-as-executed": { post: { tags: ["operations"], summary: "Create evidence artifacts from as-executed record pointers", security: [{ bearerAuth: [] }], requestBody: { required: true, content: { "application/json": { schema: ref("GenericOkResponse") } } }, responses: { "200": jsonResponse(ref("GenericOkResponse"), "Evidence artifacts recorded"), "400": jsonResponse(ref("GenericOkResponse"), "Invalid input"), "401": jsonResponse(ref("GenericOkResponse"), "Missing or invalid auth"), "403": jsonResponse(ref("GenericOkResponse"), "Forbidden"), "404": jsonResponse(ref("GenericOkResponse"), "Missing as-executed record"), "409": jsonResponse(ref("GenericOkResponse"), "Duplicate idempotency key"), "422": jsonResponse(ref("GenericOkResponse"), "Evidence materialization rejected") }, "x-geox-governance": { owner: "evidence-service / act-service", audience: "operator/executor", boundary: "official", auth_scope: "evidence.artifact.write", error_model: "GEOX_STANDARD_ERROR_ENVELOPE_V2", contract_ref: "docs/contracts/v2/EVIDENCE_AND_ACCEPTANCE_CONTRACT_V2.md", gate_maturity: "ci_enforced" } } },
    "/api/v1/as-executed/from-ao-act-receipt-v1": { post: { tags: ["operations"], summary: "Create as-executed and as-applied from H41 AO-ACT receipt v1", security: [{ bearerAuth: [] }], requestBody: { required: true, content: { "application/json": { schema: ref("AsExecutedFromReceiptRequest") } } }, responses: { "200": jsonResponse(ref("AsExecutedFromReceiptResponse"), "H41 AO-ACT receipt normalized into as-executed and as-applied"), "400": jsonResponse(ref("GenericOkResponse"), "Invalid input"), "401": jsonResponse(ref("GenericOkResponse"), "Missing or invalid auth"), "403": jsonResponse(ref("GenericOkResponse"), "Forbidden"), "404": jsonResponse(ref("GenericOkResponse"), "Missing receipt or operation plan"), "409": jsonResponse(ref("GenericOkResponse"), "Duplicate or conflict rejection"), "422": jsonResponse(ref("GenericOkResponse"), "H41 eligibility rejection") }, "x-geox-governance": { owner: "act-service", audience: "operator", boundary: "official", auth_scope: "ao_act.receipt.write", error_model: "GEOX_STANDARD_ERROR_ENVELOPE_V2", contract_ref: "docs/contracts/v2/AO_ACT_AND_AO_SENSE_BOUNDARY_CONTRACT_V2.md", gate_maturity: "ci_enforced" } } },
