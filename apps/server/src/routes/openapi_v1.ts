...
function applyP13OpenApiAlignment(spec: any) {
  ...
  Object.assign(spec.paths, {
    ...
    "/api/v1/as-executed/from-ao-act-receipt-v1": { post: { tags: ["operations"], summary: "Create as-executed and as-applied from H41 AO-ACT receipt v1", requestBody: { required: true, content: { "application/json": { schema: ref("AsExecutedFromReceiptRequest") } } }, responses: { "200": jsonResponse(ref("AsExecutedFromReceiptResponse"), "H41 AO-ACT receipt normalized into as-executed and as-applied"), "409": jsonResponse(ref("GenericOkResponse"), "Duplicate or conflict rejection") } } },
