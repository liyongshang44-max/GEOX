...
export const METRIC_DISPLAY_POLICY_V1: Readonly<Record<TelemetryMetricNameV1, MetricDisplayPolicyItemV1>> = Object.freeze({
  ...
  inlet_flow_lpm: {
    ...
    display_tier: "professional_detail",
    reasoning_status: "SECONDARY_REASONING_INPUT",
    display_label_zh: "入口流量",
    display_label_en: "Inlet Flow",
    canonical_unit: "L/min",
    show_on_dashboard: false,
    show_on_field_summary: false,
    show_on_field_detail: true,
    show_on_device_detail: true,
    show_on_explain: true,
    source_field_key: "sensor.inlet_flow_lpm",
    source_field_aliases: ["water.inlet_flow", "irrigation.inlet_flow"],
    fixed_routes: ["field.detail", "explain.evidence_basis"],
    customer_story_allowed: false,
  },
  outlet_flow_lpm: {
    ...
    display_tier: "professional_detail",
    reasoning_status: "SECONDARY_REASONING_INPUT",
    display_label_zh: "出口流量",
    display_label_en: "Outlet Flow",
    canonical_unit: "L/min",
    show_on_dashboard: false,
    show_on_field_summary: false,
    show_on_field_detail: true,
    show_on_device_detail: true,
    show_on_explain: true,
    source_field_key: "sensor.outlet_flow_lpm",
    source_field_aliases: ["water.outlet_flow", "irrigation.outlet_flow"],
    fixed_routes: ["field.detail", "explain.evidence_basis"],
    customer_story_allowed: false,
  },
  pressure_drop_kpa: {
    ...
    reasoning_status: "SECONDARY_REASONING_INPUT",
    display_label_zh: "压降",
    display_label_en: "Pressure Drop",
    canonical_unit: "kPa",
    show_on_dashboard: false,
    show_on_field_summary: true,
    show_on_field_detail: true,
    show_on_device_detail: true,
    show_on_explain: true,
    source_field_key: "sensor.pressure_drop_kpa",
    source_field_aliases: ["water.pressure_drop", "irrigation.pressure_drop"],
    fixed_routes: ["field.summary", "field.detail", "explain.signal"],
    customer_story_allowed: true,
  },
});
