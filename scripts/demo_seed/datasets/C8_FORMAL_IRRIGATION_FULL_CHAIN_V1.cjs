...
const FIELD_MEMORY_CANDIDATE_ID = 'fm_candidate_c8_irrigation_001';
const FIELD_MEMORY_RECORD_ID = 'fm_record_c8_irrigation_001';
...
function buildC8FormalIrrigationFullChainDataset(options) {
  ...
  const memoryCandidateBasisRefs = [
    ...
    { kind: 'recurrence_context_v1', ref_id: `${pre}_recurrence_context_c8_001` },
    { kind: 'operator_review_v1', ref_id: `${pre}_operator_review_c8_memory_001` },
  ];
  const memoryPromotionBasisRefs = [
    { kind: 'promotion_review_v1', ref_id: `${pre}_promotion_review_c8_001` },
    { kind: 'memory_record_policy_v1', ref_id: `${pre}_memory_record_policy_c8_001` },
    { kind: 'agronomic_reviewer_approval_v1', ref_id: `${pre}_agronomic_reviewer_approval_c8_001` },
...
function applyC8FormalE2ESeedPolicy(dataset) {
  ...
  manifest.field_memory_flow = ['acceptance_result_v1', 'outcome_review_v1', 'roi_boundary_v1', 'roi_ledger_v1', 'field_memory_candidate_v1', 'field_memory_record_v1', 'field-memory/from-acceptance', 'POST /api/v1/field-memory/from-acceptance', 'field_memory_v1', 'GET /api/v1/customer/fields/field_c8_demo/memory'];
