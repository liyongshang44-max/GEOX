...
function buildC8FormalIrrigationFullChainDataset(options) {
  ...
  const waterStateEstimate = {
    estimate_id: WATER_STATE_ESTIMATE_ID,
    field_id: FIELD_ID,
    season_id: SEASON_ID,
