...
function applyC8FormalE2ESeedPolicy(dataset) {
  ...
  manifest.field_memory_flow = ['acceptance_result_v1', 'field_memory_candidate_v1', 'field_memory_record_v1', 'field-memory/from-acceptance', 'POST /api/v1/field-memory/from-acceptance', 'field_memory_v1', 'GET /api/v1/customer/fields/field_c8_demo/memory'];
