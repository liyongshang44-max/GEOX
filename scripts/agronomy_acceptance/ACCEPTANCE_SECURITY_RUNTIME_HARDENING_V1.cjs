...
const base=env('BASE_URL','http://127.0.0.1:3000'); const h=await fetchJson(`${base}/api/admin/healthz`); checks.healthz_runtime_security=Boolean(h.json?.runtime_security?.checks);
