...
const EXPECTED_BASE_MAIN = '2cc901168ad208873ec6558a1a712fcfe887bf14';
...
async function main() {
  ...
  assert.equal(git('merge-base', EXPECTED_BASE_MAIN, SUBJECT_SHA), EXPECTED_BASE_MAIN, 'T1R1_COVERAGE_MUST_DESCEND_FROM_EXACT_MAIN');
