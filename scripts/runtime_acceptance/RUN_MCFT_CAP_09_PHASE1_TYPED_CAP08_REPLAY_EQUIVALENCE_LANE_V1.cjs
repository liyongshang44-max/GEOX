...
const NORMALIZED_OPERATIONAL_RUN_INSTANCE_ID='MCFT-CAP08-PHASE1-TYPED-EQUIVALENCE-001';
...
async function main(){
  ...
  const runProductChainV1=lane==='SUCCESSOR'
    ? requireFromRoot(root,'scripts/runtime_acceptance/mcft_cap09_phase1_typed_replay_host_product_chain_v1.cjs').runPhase1TypedReplayHostProductChainV1
    : requireFromRoot(root,'scripts/runtime_acceptance/mcft_cap08_s6_single_run_ports/product_chain_v1.cjs').runProductChainV1;
  assert.equal(typeof runProductChainV1,'function','CAP08_EQUIVALENCE_PRODUCT_CHAIN_REQUIRED');
  ...
  try{
    ...
    const semanticManifest={
      schema_version:'geox_mcft_cap09_phase1_typed_cap08_replay_equivalence_lane_manifest_v1',
    ...
    const result={
      schema_version:'geox_mcft_cap09_phase1_typed_cap08_replay_equivalence_lane_result_v1',
      status:'PASS',
      lane,
      ...
      successor_uses_typed_replay_host_composition:lane==='SUCCESSOR',
