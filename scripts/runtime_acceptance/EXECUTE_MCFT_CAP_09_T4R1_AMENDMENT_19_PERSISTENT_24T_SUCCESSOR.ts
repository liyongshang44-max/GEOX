...
const PREVIOUS_MAIN_DB = "geox_mcft_cap09_s6_accel24t_am19_v8";
const PREVIOUS_BLOCKED_DB = "geox_mcft_cap09_s6_accel24t_am19_blocked_v8";
const MAIN_DB = "geox_mcft_cap09_s6_accel24t_am19_v9";
const BLOCKED_DB = "geox_mcft_cap09_s6_accel24t_am19_blocked_v9";
...
function build(): string {
  ...
  assert(generated.includes(MAIN_DB), "T4R1_AM19_P24_V9_MAIN_DB_REQUIRED");
  assert(generated.includes(BLOCKED_DB), "T4R1_AM19_P24_V9_BLOCKED_DB_REQUIRED");
  assert(!generated.includes(PREVIOUS_MAIN_DB), "T4R1_AM19_P24_V8_MAIN_DB_REUSE_FORBIDDEN");
  assert(!generated.includes(PREVIOUS_BLOCKED_DB), "T4R1_AM19_P24_V8_BLOCKED_DB_REUSE_FORBIDDEN");
  return generated;
}
