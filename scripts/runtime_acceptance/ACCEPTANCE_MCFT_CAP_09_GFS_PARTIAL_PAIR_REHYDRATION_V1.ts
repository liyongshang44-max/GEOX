...
function pairDecoder(restoredAt:string):ExternalEvidenceDecoderPortV1{
  return {
    ...
    async decodeRetainedEvidence(input){
      ...
      const common={origin_source_kind:"NOAA_NCEP_NOMADS_GFS",epistemic_class:"ASSUMED" as const,available_to_runtime_at:AVAILABLE,role_time:{issued_at:CYCLE,ingested_at:restoredAt,valid_from:TARGET,valid_to:"2026-09-04T20:00:00.000Z"},quality:{status:"PASS" as const},source_unit:"governed_multi_variable_bundle",canonical_unit:"governed_multi_variable_bundle",conversion_rule:{conversion_rule_id:"FOCUSED_GFS_PARTIAL_REHYDRATION_RULE_V1",conversion_rule_version:"1",authority_ref:"GEOX-MCFT-CAP-09-AMENDMENT-01"},source_binding_version:1,limitations:["FOCUSED_GFS_PARTIAL_PAIR_QUALIFICATION_ONLY"]};
      return [
