...
} from "../../apps/server/src/runtime/twin_runtime/external_formal_cap04_candidate_execution_service_v1.js";
...
async function main(): Promise<void> {
  ...
  assert.equal(a1Again.forecast_authority.forecast_candidate.status, "COMPLETED");
  ...
  const a2 = executeExternalFormalCap04CandidateV1({
    ...rawInputV1(fixture),
    candidate_records: blockedRecords,
  });
  ...
  assert.throws(() => executeExternalFormalCap04CandidateV1({
    ...rawInputV1(fixture),
    candidate_records: malformedRecords,
  ...
  assert.throws(() => executeExternalFormalCap04CandidateV1({
    ...rawInputV1(fixture),
    candidate_records: badBindingRecords,
  ...
  assert.throws(() => executeExternalFormalCap04CandidateV1({
    ...rawInputV1(fixture),
    candidate_records: [...fixture.candidates, operationEvidence],
  ...
  assert.throws(() => executeExternalFormalCap04CandidateV1({
    ...rawInputV1(fixture),
    handoff: badRealityHandoff,
  }), /EXTERNAL_CAP04_SERVICE_REALITY_BINDING_MISMATCH/);
