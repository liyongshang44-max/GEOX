...
check('expected_final_tag', review.expected_final_tag === 'p46_recommendation_from_twin_governance_gate_v0');
check('expected_closure_tag', review.expected_closure_tag === 'p46_recommendation_from_twin_governance_gate_v0_closure');
