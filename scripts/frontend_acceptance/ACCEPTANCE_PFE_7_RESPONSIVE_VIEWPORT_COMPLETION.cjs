...
try {
  ...
  assert('customer_dashboard_index_row_responsive_strategy', includesAll(responsiveCss, ['.customerIndexRow', 'grid-template-columns: minmax(0, 1fr) auto', 'overflow-wrap: anywhere']));
