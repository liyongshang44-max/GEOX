...
mustHave(overlay, 'SALES_CRITICAL_OPENAPI_PATHS_V1', 'sales critical overlay path export');
mustHave(overlay, 'SALES_CRITICAL_OPENAPI_SCHEMAS_V1', 'sales critical overlay schema export');
mustHave(openapi, 'SALES_CRITICAL_OPENAPI_PATHS_V1', 'OpenAPI runtime imports overlay paths');
mustHave(openapi, 'SALES_CRITICAL_OPENAPI_SCHEMAS_V1', 'OpenAPI runtime imports overlay schemas');
mustHave(openapi, 'Object.assign(spec.paths', 'OpenAPI runtime merges overlay paths');
mustHave(openapi, 'Object.assign(spec.components.schemas', 'OpenAPI runtime merges overlay schemas');
mustHave(overlay, 'x-geox-governance', 'overlay governance extension');
mustHave(overlay, 'operationId', 'overlay operationId');
mustHave(overlay, 'security', 'overlay security');
mustHave(overlay, 'responses', 'overlay responses');
mustHave(overlay, 'requestBody', 'overlay write requestBody');
