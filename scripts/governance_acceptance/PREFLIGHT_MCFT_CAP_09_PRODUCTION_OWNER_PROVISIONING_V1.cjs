...
try{
  ...
  req(a.status==="READINESS_ONLY_PROVISIONING_NOT_ARMED","OWNER_PROVISIONING_AUTHORITY_STATUS_REQUIRED");
  req(a.target_database?.status==="NOT_BOUND"&&a.target_database?.database_name===null,"OWNER_PROVISIONING_TARGET_MUST_BE_UNBOUND");
