...
(async () => {
  ...
  try {
    ...
    const result={status:'FAIL',capability_line_id:'MCFT-CAP-08',change_class:'NON_CANDIDATE_POST_CLOSURE_CURRENT_FRONTIER_RECONCILIATION',base_sha:baseSha||null,head_sha,error:error instanceof Error?error.message:String(error)};
