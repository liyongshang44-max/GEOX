...
const READY_HEAD = 'c88f555685ad8d79618f6ceb21d702264f37bfe7';
const READY_EXACT_HEAD_CI = '4575_SUCCESS';
const READY_HEAD_FINAL_GATE = '141_PASS_0_FAIL';
...
check(closure.ready_head === READY_HEAD, 'Closure READY head evidence exact');
check(closure.ready_exact_head_ci === READY_EXACT_HEAD_CI, 'Closure READY exact-head CI evidence exact');
check(closure.final_acceptance?.closure_final_gate_on_ready_head === READY_HEAD_FINAL_GATE, 'Closure READY-head Final Gate evidence exact');
check(closure.final_acceptance?.twenty_four_tick_postgresql === '8_PASS_0_FAIL', 'Closure 24-tick PostgreSQL evidence exact');
check(closure.final_acceptance?.restart_backfill_postgresql === '8_PASS_0_FAIL', 'Closure restart/backfill PostgreSQL evidence exact');
check(closure.final_acceptance?.persistence_postgresql === '15_PASS_0_FAIL', 'Closure persistence PostgreSQL evidence exact');
check(closure.final_acceptance?.failure_recovery_postgresql === '8_PASS_0_FAIL', 'Closure Failure Recovery PostgreSQL evidence exact');
...
check(record.ready_head === READY_HEAD, 'Closure Record READY head exact');
check(record.ready_exact_head_ci === READY_EXACT_HEAD_CI, 'Closure Record READY exact-head CI exact');
check(record.acceptance_evidence.closure_final_gate === READY_HEAD_FINAL_GATE, 'Closure Record Final Gate evidence exact');
check(record.acceptance_evidence.closure_final_gate_head === READY_HEAD, 'Closure Record Final Gate head exact');
check(record.acceptance_evidence.twenty_four_tick_postgresql === '8_PASS_0_FAIL', 'Closure Record 24-tick PostgreSQL evidence exact');
check(record.acceptance_evidence.restart_backfill_postgresql === '8_PASS_0_FAIL', 'Closure Record restart/backfill PostgreSQL evidence exact');
...
check(cap02.closure.ready_head === READY_HEAD, 'matrix Closure READY head exact');
check(cap02.closure.ready_exact_head_ci === READY_EXACT_HEAD_CI, 'matrix Closure READY exact-head CI exact');
check(cap02.closure.final_gate_on_ready_head === READY_HEAD_FINAL_GATE, 'matrix Closure Final Gate evidence exact');
check(cap02.closure.postgresql_acceptance?.twenty_four_tick === '8_PASS_0_FAIL', 'matrix Closure 24-tick PostgreSQL evidence exact');
check(cap02.closure.postgresql_acceptance?.restart_backfill === '8_PASS_0_FAIL', 'matrix Closure restart/backfill PostgreSQL evidence exact');
check(cap02.closure.postgresql_acceptance?.persistence === '15_PASS_0_FAIL', 'matrix Closure persistence PostgreSQL evidence exact');
check(cap02.closure.postgresql_acceptance?.failure_recovery === '8_PASS_0_FAIL', 'matrix Closure Failure Recovery PostgreSQL evidence exact');
