...
try{
 ...
 for(const k of ["production_writer_owner_self_grant_cleanup_authorized","production_evidence_acl_carryforward_remediation_authorized","runtime_process_start_authorized","production_owner_activation_authorized","formal_v5_arm_authorized","a0_authorized","o00_authorized"])assert.equal(arm[k],false,"WRITER_OWNER_CLEANUP_UNARMED_AUTHORITY_MUST_BE_FALSE:"+k);
