...
const productionMatches=cp.execFileSync("git",["grep","-l","decisionEligibilityPolicyDeclarationV1Schema.parse(","--","apps/server/src","!apps/server/src/**/*.test.ts"],{encoding:"utf8"}).trim().split(/\r?\n/).filter(Boolean);
