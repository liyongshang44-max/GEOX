...
function mcft(){const task="docs/digital_twin/mcft/cap_09/GEOX-MCFT-CAP-09-TASK.md",prod="docker-compose.mcft-cap09-production.yml",dist="apps/server/scripts/write_dist_entries.cjs",pv2="apps/server/src/runtime/twin_runtime/mcft_cap09_twin_runtime_process_v2.ts",cv2="apps/server/src/runtime/twin_runtime/mcft_cap09_twin_runtime_composition_v2.ts",tick="apps/server/src/runtime/twin_runtime/external_formal_v3_amendment19_persistent_tick_service_v1.ts",residual="apps/server/src/runtime/twin_runtime/forecast_residual_outcome_tick_service_v1.ts",binding="apps/server/src/domain/twin_runtime/external_formal_evidence_binding_profile_v1.ts",rehearsal="scripts/runtime_acceptance/RUN_MCFT_CAP_09_REAL_CLOCK_REHEARSAL_V1.cjs",qcompose="docker-compose.mcft-cap09-phase5-qualification.yml",qentry="apps/server/src/runtime/twin_runtime/qualification/mcft_cap09_phase5_twin_runtime_qualification_v1.ts",h6="docs/digital_twin/mcft/cap_09/GEOX-MCFT-CAP-09-FORMAL-V5-PRODUCTION-ACTIVATION-SEAM-V1.json",c06="docs/digital_twin/mcft/cap_06/GEOX-MCFT-CAP-06-CLOSURE-RECORD.json",c07r="apps/server/src/modules/operator/registerOperatorModule.ts",c07a="scripts/runtime_acceptance/ACCEPTANCE_MCFT_CAP_07_CAP04_FORECAST_PAYLOAD_COMPATIBILITY_DB.ts",proute="scripts/governance_acceptance/ACCEPTANCE_MCFT_CAP_09_PRODUCTION_TWIN_PROCESS_V2_ROUTING_V1.cjs",plaunch="scripts/runtime_acceptance/ACCEPTANCE_MCFT_CAP_09_PRODUCTION_LOCAL_TWO_SERVICE_LAUNCHER_V1.ts";const out=[];const hosting="docs/digital_twin/mcft/cap_09/GEOX-MCFT-CAP-09-PRODUCTION-HOSTING-ARCHITECTURE-AND-DEVELOPMENT-ROUTE-V1.md",s5service="apps/server/src/runtime/twin_runtime/shadow_online_canonical_integration_service_v1.ts",s5adapter="apps/server/src/runtime/twin_runtime/postgres_cap04_shadow_online_canonical_tick_adapter_v1.ts",req=has(task,"Residual creation only when verification Evidence becomes eligible")&&has(task,"Permitted canonical families remain A/B/C/F"),cap05ReplayNoHost=has(hosting,"| CAP-05 | Human Decision / Execution Feedback consumption | Replay | No |"),s5CallerInvoked=has(s5service,'execution_model: "CALLER_INVOKED_ONE_SLOT_ONLY"'),s5ProductionWiringForbidden=has(s5service,"production_wiring_allowed: false"),controlledResidual=has(s5adapter,"Cap05ForecastResidualOutcomeTickServiceV1")&&has(s5adapter,"c_residual_attempted")&&has(s5adapter,"c_residual_disposition"),productionResidual=has(cv2,"Cap05ForecastResidualOutcomeTickServiceV1")||has(pv2,"Cap05ForecastResidualOutcomeTickServiceV1")||has(tick,"Cap05ForecastResidualOutcomeTickServiceV1"),m01ok=req&&cap05ReplayNoHost&&s5CallerInvoked&&s5ProductionWiringForbidden&&controlledResidual&&!productionResidual;out.push({id:"M-01",subject:"CAP05_FORECAST_RESIDUAL_EXECUTION_OWNER_AND_RUNTIME_REACHABILITY",final_disposition:m01ok?"WIRED_AND_PROVEN":"UNWIRED_DEFECT",expected_execution_owner:"CALLER_INVOKED_CONTROLLED_REPLAY_SHADOW_ONLINE_S5_COMPOSITION",expected_execution_root:"ShadowOnlineCanonicalIntegrationServiceV1 -> PostgresCap04ShadowOnlineCanonicalTickAdapterV1",evidence:{taskbook_requires_residual_eligibility:req,cap05_primary_mode_replay_and_no_dedicated_long_running_host:cap05ReplayNoHost,hosting_authority_ref:hosting,s5_service_ref:s5service,s5_execution_model_caller_invoked:s5CallerInvoked,s5_production_wiring_explicitly_forbidden:s5ProductionWiringForbidden,controlled_residual_path_reachable:controlledResidual,production_v2_direct_residual_reachable:productionResidual,residual_symbol_hits:hits("Cap05ForecastResidualOutcomeTickServiceV1")},intentional_disconnect_edge:"CAP05_S5_RESIDUAL_IS_NOT_A_LONG_RUNNING_PRODUCTION_V2_DAEMON_OR_SERVER_STARTUP_EDGE"});const p100=has(binding,"POINT_100MM_TO_ROOT_ZONE_MEAN_H1_WITH_REPRESENTATIVENESS_V1"),c200=has(residual,"POINT_200MM_TO_ROOT_ZONE_MEAN_H1_WITH_REPRESENTATIVENESS_V1"),c100=has(residual,"POINT_100MM_TO_ROOT_ZONE_MEAN_H1_WITH_REPRESENTATIVENESS_V1"),directEdgeExpected=!s5ProductionWiringForbidden&&productionResidual;out.push({id:"M-02",subject:"CAP09_100MM_PRODUCER_VS_CAP05_RESIDUAL_CONSUMER_SEMANTIC_COMPATIBILITY",final_disposition:directEdgeExpected?(p100&&c200&&!c100?"SEMANTICALLY_INCOMPATIBLE":"WIRED_AND_PROVEN"):"INTENTIONALLY_DISCONNECTED",evidence:{producer_operator:"POINT_100MM_TO_ROOT_ZONE_MEAN_H1_WITH_REPRESENTATIVENESS_V1",producer_ref:binding,consumer_operator:c200?"POINT_200MM_TO_ROOT_ZONE_MEAN_H1_WITH_REPRESENTATIVENESS_V1":null,consumer_ref:residual,consumer_accepts_100mm:c100,direct_production_edge_expected:directEdgeExpected,s5_production_wiring_explicitly_forbidden:s5ProductionWiringForbidden},intentional_disconnect_edge:"NO_AUTHORIZED_DIRECT_CAP09_EXTERNAL_100MM_TO_CAP05_200MM_PRODUCTION_EDGE; FUTURE LATE-EXACT VERIFICATION REQUIRES SEPARATE AUTHORIZED CONTRACT"});const invariant=has(hosting,"qualification canonical core")&&has(hosting,"production canonical core"),qv1=has(qentry,"runMcftCap09TwinRuntimeProcessV1"),pv=has(prod,"mcft_cap09_twin_runtime_v2.js")&&has(dist,"runMcftCap09TwinRuntimeProcessV2")&&has(pv2,"composeMcftCap09TwinRuntimeV2"),rq=has(rehearsal,"docker-compose.mcft-cap09-phase5-qualification.yml"),qrunner=has("apps/server/src/runtime/twin_runtime/mcft_cap09_twin_runtime_composition_v1.ts","ExternalFormalV3Amendment19RunnerV1"),prunner=has(cv2,"ExternalFormalV4Amendment19RunnerV2"),qctx=has("apps/server/src/runtime/twin_runtime/mcft_cap09_twin_runtime_composition_v1.ts","materializeExternalFormalA18CropContextV3"),pctx=has(cv2,"materializeExternalFormalA18CropContextV4"),sharedTick=has("apps/server/src/runtime/twin_runtime/mcft_cap09_twin_runtime_composition_v1.ts","ExternalFormalV3Amendment19PersistentTickServiceV1")&&has(cv2,"ExternalFormalV3Amendment19PersistentTickServiceV1"),exactPathEqual=qv1===false&&pv===true&&qrunner===prunner&&qctx===pctx;out.push({id:"M-03",subject:"REAL_CLOCK_REHEARSAL_V1_VS_PRODUCTION_V2_EXACT_PATH_EQUIVALENCE",final_disposition:invariant&&rq&&qv1&&pv&&!exactPathEqual?"UNWIRED_DEFECT":"WIRED_AND_PROVEN",evidence:{hosting_invariant_ref:hosting,qualification_canonical_core_equals_production_canonical_core_required:invariant,rehearsal_control_ref:rehearsal,rehearsal_uses_qualification_compose:rq,qualification_compose_ref:qcompose,qualification_entry_ref:qentry,qualification_routes_to_process_v1:qv1,production_routes_to_process_v2:pv,qualification_runner_v1:qrunner,production_runner_v2:prunner,qualification_crop_context_v3:qctx,production_crop_context_v4:pctx,shared_persistent_tick_service:sharedTick,exact_binary_path_equal:exactPathEqual,explicit_current_v1_v2_equivalence_proof_found:false}});const c6=ex(c06)?js(c06):{},r6=["apps/server/scripts/mcft/MCFT_CAP_06_CALIBRATION_SHADOW_RUNNER.ts","apps/server/scripts/mcft/MCFT_CAP_06_PAIRED_HISTORICAL_SHADOW_RUNNER.ts"],w6=[".github/workflows/mcft-cap-06-s5-candidate.yml",".github/workflows/mcft-cap-06-s6-paired-shadow.yml"],ok6=c6.runtime_mode==="CONTROLLED_REPLAY"&&c6.status==="COMPLETE"&&r6.every(ex)&&w6.every(ex);out.push({id:"M-04",subject:"CAP06_CONTROLLED_CALIBRATION_SHADOW_EXECUTION_OWNERSHIP",final_disposition:ok6?"WIRED_AND_PROVEN":"UNWIRED_DEFECT",expected_execution_owner:"CONTROLLED_REPLAY_RUNNERS",evidence:{closure_ref:c06,runtime_mode:c6.runtime_mode||null,closure_status:c6.status||null,runners:r6.map(p=>({path:p,present:ex(p)})),workflows:w6.map(p=>({path:p,present:ex(p)})),production_hourly_process_required:false},intentional_disconnect_edge:"CAP06_CONTROLLED_REPLAY_IS_NOT_REQUIRED_INSIDE_CAP09_HOURLY_PRODUCTION_PROCESS"});const ok7=has(c07r,"registerMcftFieldTwinReadRoutesV1")&&has(c07r,"PostgresMcftFieldTwinS4ReadApiV1")&&ex(c07a);out.push({id:"M-05",subject:"CAP07_FIELD_TWIN_READ_SURFACE_RUNTIME_REACHABILITY",final_disposition:ok7?"WIRED_AND_PROVEN":"UNWIRED_DEFECT",expected_execution_owner:"HTTP_SERVER_OPERATOR_MODULE",evidence:{registration_ref:c07r,runtime_acceptance_ref:c07a,route_registered:ok7}});const m=js(MATRIX),c8=(m.capability_lines||[]).find(x=>x.capability_line_id==="MCFT-CAP-08")||{},ok8=c8.complete===true&&c8.current_effective_status==="MCFT_CAP_08_COMPLETE"&&c8.production_runtime_source_authorized===false;out.push({id:"M-06",subject:"CAP08_REPLAY_DECISION_ACTION_EXECUTION_BOUNDARY",final_disposition:ok8?"WIRED_AND_PROVEN":"UNWIRED_DEFECT",expected_execution_owner:"CONTROLLED_REPLAY_STAGE_1A",evidence:{matrix_ref:MATRIX,complete:c8.complete??null,current_effective_status:c8.current_effective_status||c8.status||null,production_runtime_source_authorized:c8.production_runtime_source_authorized??null},intentional_disconnect_edge:"CAP08_PRODUCTION_RUNTIME_SOURCE_IS_EXPLICITLY_UNAUTHORIZED"});const root=has(prod,"apps/server/dist/runtime/mcft_cap09_twin_runtime_v2.js")&&has(dist,"runMcftCap09TwinRuntimeProcessV2")&&has(pv2,"composeMcftCap09TwinRuntimeV2")&&has(cv2,"ExternalFormalV4Amendment19RunnerV2")&&has(cv2,"ExternalFormalV3Amendment19PersistentTickServiceV1")&&ex(proute)&&ex(plaunch);out.push({id:"M-07",subject:"CAP09_PRODUCTION_ROOT_EXACTNESS",final_disposition:root?"WIRED_AND_PROVEN":"UNWIRED_DEFECT",expected_execution_owner:"MCFT_CAP09_PRODUCTION_TWIN_RUNTIME_V2",evidence:{chain:[prod,dist,pv2,cv2,"apps/server/src/runtime/twin_runtime/external_formal_v4_amendment19_runner_v2.ts",tick],routing_acceptance_ref:proute,launcher_acceptance_ref:plaunch,static_and_packaging_route_closed:root,claim_scope:"PRODUCTION_ROOT_PACKAGING_AND_COMPOSITION_EXACTNESS_ONLY",formal_v5_runtime_execution_claimed:false}});return out;}
