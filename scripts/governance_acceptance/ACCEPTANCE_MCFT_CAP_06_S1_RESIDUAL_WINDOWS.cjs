...
const EXPECTED_EFFECTIVENESS_FILES = ["docs/digital_twin/GEOX-DT-02-MCFT-IMPLEMENTATION-MAP.md","docs/digital_twin/GEOX-MCFT-VERTICAL-CAPABILITY-LINE-MATRIX.json","docs/digital_twin/mcft/cap_06/GEOX-MCFT-CAP-06-CURRENT-STATE-RECONCILIATION.json","docs/digital_twin/mcft/cap_06/GEOX-MCFT-CAP-06-DELIVERY-SLICE-STATUS.json","docs/digital_twin/mcft/cap_06/GEOX-MCFT-CAP-06-S1-EFFECTIVENESS.json","docs/digital_twin/mcft/cap_06/GEOX-MCFT-CAP-06-S1-RESIDUAL-WINDOWS-STATUS.json","docs/digital_twin/mcft/cap_06/GEOX-MCFT-CAP-06-TASK.md","scripts/governance_acceptance/ACCEPTANCE_MCFT_CAP_06_S1_RESIDUAL_WINDOWS.cjs","scripts/runtime_acceptance/ACCEPTANCE_MCFT_CAP_06_S0_V2_EXACT_QUALIFICATION.ts"];
const EXPECTED_FILES = ["docs/digital_twin/GEOX-DT-02-MCFT-IMPLEMENTATION-MAP.md", "docs/digital_twin/GEOX-MCFT-VERTICAL-CAPABILITY-LINE-MATRIX.json", "docs/digital_twin/mcft/cap_06/GEOX-MCFT-CAP-06-CURRENT-STATE-RECONCILIATION.json", "docs/digital_twin/mcft/cap_06/GEOX-MCFT-CAP-06-DELIVERY-SLICE-STATUS.json", "docs/digital_twin/mcft/cap_06/GEOX-MCFT-CAP-06-S1-RESIDUAL-WINDOWS.json", "docs/digital_twin/mcft/cap_06/GEOX-MCFT-CAP-06-S1-RESIDUAL-WINDOWS-STATUS.json", "docs/digital_twin/mcft/cap_06/GEOX-MCFT-CAP-06-S1-RESIDUAL-WINDOWS.md", "docs/digital_twin/mcft/cap_06/GEOX-MCFT-CAP-06-TASK.md", "scripts/acceptance/run_acceptance.cjs", "scripts/governance_acceptance/ACCEPTANCE_MCFT_CAP_06_AUTHORIZATION.cjs", "scripts/governance_acceptance/ACCEPTANCE_MCFT_CAP_06_S1_RESIDUAL_WINDOWS.cjs", "scripts/runtime_acceptance/ACCEPTANCE_MCFT_CAP_06_S1_RESIDUAL_WINDOWS_DB.ts", "scripts/runtime_acceptance/RUN_MCFT_CAP_06_S1_RESIDUAL_WINDOWS.cjs", "scripts/runtime_acceptance/mcft_cap_06_s1_residual_windows_fixture_v1.ts"];
...
function main() {
  ...
  assert.equal(status.effectiveness.implementation_exact_head, '57d9844528665a5ae3ecbd0ccf0406bf3c5e91cd');
  assert.equal(status.effectiveness.implementation_exact_head_ci_run, 29475482824);
  assert.equal(status.effectiveness.merge_commit, '6db3f8d0c2b2ba7bcc48993b4b4783332e2ae62b');
  ...
  assert.equal(status.effectiveness.postmerge_probe_pr_number, 2515);
  assert.equal(status.effectiveness.postmerge_workflow_run, 29476027885);
  ...
  assert.equal(effectiveness.implementation_exact_head, '57d9844528665a5ae3ecbd0ccf0406bf3c5e91cd');
  assert.equal(effectiveness.implementation_exact_head_ci_run, 29475482824);
  assert.equal(effectiveness.implementation_merge_commit, '6db3f8d0c2b2ba7bcc48993b4b4783332e2ae62b');
  ...
  assert.equal(effectiveness.postmerge_probe_pr_number, 2515);
  assert.equal(effectiveness.postmerge_workflow_run, 29476027885);
  ...
  assert.equal(delivery.blocked_slices.includes('MCFT-CAP-06.MCFT-03-12.D-GOVERNANCE-PERSISTENCE-RECOVERY-V1'), true);
  ...
  assert.equal(completedS1.exact_head, '57d9844528665a5ae3ecbd0ccf0406bf3c5e91cd');
  assert.equal(completedS1.exact_head_ci_run, 29475482824);
  assert.equal(completedS1.merge_commit, '6db3f8d0c2b2ba7bcc48993b4b4783332e2ae62b');
  assert.equal(completedS1.postmerge_workflow_run, 29476027885);
  ...
  console.log('PASS MCFT-CAP-06 immutable S1 exact 24 Residual refs and hashes');
