...
const ACCEPTANCE_NAME = "ACCEPTANCE_ROOT_ZONE_SOIL_WATER_FORECAST_SCHEMA_MIGRATION_V1";
const MIGRATION_PATH = "apps/server/db/migrations/2026_06_21_root_zone_soil_water_forecast_v1.sql";
const TABLE_NAME = "root_zone_soil_water_forecast_index_v1";
const PROBE_ID = "h33_root_zone_soil_water_forecast_acceptance_schema_probe";
...
const REQUIRED_INDEXES = [
  "idx_root_zone_soil_water_forecast_index_v1_scope_latest",
  "idx_root_zone_soil_water_forecast_index_v1_field_latest",
  "idx_root_zone_soil_water_forecast_index_v1_source_state",
];
  ...
  await client.query(
    `
      ...
      VALUES (
        ...
        'state_probe', 'state_probe', 'NO_NEW_ACTION', 7, 60, 100,
        0, 0, 'ESTIMATED', 'schema_probe_hash', '2026-06-21T00:00:00Z'
      )
    `,
    [PROBE_ID],
  );
