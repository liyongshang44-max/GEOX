...
const EXPECTED_BASE = 'bf5c09e0eef5d666d190298cbe7cb4d6655de1e7';
const F = {
...
const result = {
  ...
  base_sha: BASE,
  exact_file_count: 0,
  adoption_mode: 'STATIC_TOOLING_ONLY',
...
try {
  ...
  req(db.existing_t1r1_database_name_forbidden_as_t4r1_storage === 'geox_mcft_cap09_s6_formal_24h', 'EA5A_V3_T1R1_REUSE_GUARD_REQUIRED');
  req(db.existing_t3r1_database_name_forbidden_as_t4r1_storage === 'geox_mcft_cap09_s6_formal_t3r1_24h', 'EA5A_V3_T3R1_REUSE_GUARD_REQUIRED');
  ...
  req(fresh.cross_scope_canonical_stitching_authorized === false, 'EA5A_V3_CROSS_SCOPE_STITCHING_FORBIDDEN');
  ...
  req(workflow.includes('EA5A_V3_STATIC_ADOPTION_ONLY'), 'EA5A_V3_STATIC_ADOPTION_MARKER_REQUIRED');
