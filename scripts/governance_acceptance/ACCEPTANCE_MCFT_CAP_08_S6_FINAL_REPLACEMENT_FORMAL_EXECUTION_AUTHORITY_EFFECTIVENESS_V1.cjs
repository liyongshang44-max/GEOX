...
const P = {
  ...
  boundary: `${DOC}/GEOX-MCFT-CAP-08-S6-FINAL-REPLACEMENT-FORMAL-EXECUTION-AUTHORITY-EFFECTIVENESS-BOUNDARY-V1.json`,
  authority: `${DOC}/GEOX-MCFT-CAP-08-S6-FINAL-REPLACEMENT-FORMAL-EXECUTION-AUTHORITY-EFFECTIVENESS-V1.json`,
  runA: `${DOC}/GEOX-MCFT-CAP-08-S6-FINAL-REPLACEMENT-FORMAL-RUN-A-EXECUTION-AUTHORITY-EFFECTIVE-V1.json`,
  runB: `${DOC}/GEOX-MCFT-CAP-08-S6-FINAL-REPLACEMENT-FORMAL-RUN-B-EXECUTION-AUTHORITY-EFFECTIVE-V1.json`,
