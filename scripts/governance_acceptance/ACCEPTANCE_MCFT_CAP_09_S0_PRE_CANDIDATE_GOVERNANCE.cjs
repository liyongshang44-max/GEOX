...
for(const token of ['STAGE_1B_SHADOW_ONLINE_CLOSURE','24 actual hourly UTC scheduler boundaries','PersistentSequentialSchedulerAdapter','NO_CAP09_IMPLEMENTATION_AUTHORITY','MCFT_CAP_09_TRUSTED_REGISTRY_BOOTSTRAP'])ok(t.includes(token),'TASKBOOK:'+token);
