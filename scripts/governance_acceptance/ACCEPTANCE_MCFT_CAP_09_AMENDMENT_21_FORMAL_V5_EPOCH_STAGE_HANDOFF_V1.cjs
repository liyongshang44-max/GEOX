...
const FORMAL_SCHEMA_ACL_OWNER_MEMBERSHIP_CLEANUP_BASE="3ceff8c46a3ccdc4326438c9c4a35ea7e2d16ef0";
...
const FORMAL_SCHEMA_ACL_OWNER_MEMBERSHIP_CLEANUP_EXACT_FILES=[
  "scripts/governance_acceptance/ACCEPTANCE_MCFT_CAP_09_FORMAL_V5_H6_PRODUCTION_ACTIVATION_SEAM_V1.cjs",
  "scripts/runtime_acceptance/RUN_MCFT_CAP_09_FORMAL_V5_SCHEMA_ACL_MATERIALIZATION_V1.ts",
  SELF,
].sort();
...
if(baseEnv){
  ...
  }else if(baseEnv===FORMAL_SCHEMA_ACL_OWNER_MEMBERSHIP_CLEANUP_BASE){
    expectedFiles=FORMAL_SCHEMA_ACL_OWNER_MEMBERSHIP_CLEANUP_EXACT_FILES;
  }else{
