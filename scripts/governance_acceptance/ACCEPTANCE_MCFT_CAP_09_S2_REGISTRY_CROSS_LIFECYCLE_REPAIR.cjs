...
assert(!diff.includes('MCFT_CANDIDATE_DECLARATION_V2'),'CANDIDATE_DECLARATION_FORBIDDEN');
...
for(const token of ['s2-cross-lifecycle-repair','s2-registry-registration','s2-candidate-signal','31007579256','8930987741','MCFT_CAP09_S1_EFFECTIVE_ARTIFACT_DIR']) assert(source.includes(token),`WORKFLOW_TOKEN_REQUIRED:${token}`);
