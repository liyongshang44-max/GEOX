...
requireAll(decoder, [
  ...
  "exact_requested_target_supported",
  "missing_requested_target_fails_closed",
  "duplicate_requested_target_fails_closed",
...
console.log(JSON.stringify({
  ...
  missing_duplicate_or_incomplete_requested_target_fails_closed: true,
