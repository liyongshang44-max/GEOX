...
else if(mode==='s5-exact-sha-attestation')process.exitCode=runNode(['scripts/governance_acceptance/ACCEPTANCE_MCFT_CAP_09_S2_REGISTRY_CROSS_LIFECYCLE_REPAIR.cjs','--s5-exact-sha-route-only']);
