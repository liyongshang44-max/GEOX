...
const candidateBlobs={
 [collectorPhaseWorkflowPath]:'ca0295d98cb673ffcaa43dc994721da8b3cde4e4',
 [schedulePath]:'964fde5ad80dcf62a901184b0db3789858dfed85',
 [authorityPath]:'60a93bf530924da4b2848c7243b2edb7823fd020',
...
for(const [k,v] of Object.entries({
 ...
 database_source_to_external_cap04_acceptance:'5d468312bc2905a54bcb1f477a5df7ca6c335631',
...
eq(rc.completed_a1_candidate_forecast_point_count,72,'EA5E2_A1_FORECAST_POINTS_REQUIRED');
...
const dbToCap04Acceptance=read(dbToCap04AcceptancePath);
for(const m of ['executeExternalFormalCap04CandidateV1','delayed_rainfall_to_external_cap04','delayed_historical_et0_to_external_cap04','external_cap04_forecast_status','external_cap04_forecast_point_count','canonical_persistence_authorized','observer_offset_minutes: 437'])has(dbToCap04Acceptance,m,'EA5E2_DB_TO_CAP04_ACCEPTANCE_MISSING');
const collectorWorkflow=read(collectorPhaseWorkflowPath);
for(const m of ['ACCEPTANCE_MCFT_CAP_09_EA5E2_COLLECTOR_PHASE_ORCHESTRATION.ts','ACCEPTANCE_MCFT_CAP_09_EA5E2_EXTERNAL_FORMAL_DATABASE_EVIDENCE_SOURCE.ts','ACCEPTANCE_MCFT_CAP_09_EA5E2_DATABASE_SOURCE_TO_EXTERNAL_CAP04.ts','canonical_fact_write_count','same_slot_key_both_phases','whole_phase_validation_before_ingress','raw_retention_before_decode','future_forcing_post_logical_time_excluded','historical_s2_s5_reader_modified','delayed_rainfall_to_external_cap04','external_cap04_forecast_point_count','canonical_persistence_authorized','persist-credentials: false'])has(collectorWorkflow,m,'EA5E2_COLLECTOR_PHASE_WORKFLOW_MISSING');
...
for(const k of ['ea5e2_collector_runtime_schedule_readiness_effective','fixed_lag_schedule_frozen','scheduler_fixed_lag_seam_effective','exact_interval_late_cutoff_seam_effective','collector_runtime_ordering_executable','external_formal_database_evidence_read_path_executable','database_source_to_external_cap04_candidate_path_executable','required_ingestion_margin_frozen','ea5e3_formal_authority_v3_authorized'])yes(effect[k],`EA5E2_EFFECT_REQUIRED:${k}`);
...
const out={schema_version:'geox_mcft_cap09_ea5e2_fixed_lag_schedule_readiness_governance_result_v1',status:'PASS',base_main_sha:base,subject_head_sha:git('rev-parse','HEAD'),exact_changed_file_count:changed.length,live_provider_reproof_pass:true,collector_phase_orchestration_required:true,external_formal_database_source_read_only:true,database_source_to_external_cap04_candidate_path:true,historical_s2_s5_database_readers_mutated:false,scheduler_default_lag_hours:0,scheduler_external_formal_lag_hours:7,exact_interval_late_cutoff_offset_minutes:432,runtime_observer_offset_minutes:437,completed_a1_candidate_forecast_point_count:72,canonical_persistence_authorized:false,slot_count:24,minimum_ingestion_margin_minutes:5,formal_database_write_count:0,formal_raw_object_write_count:0,scheduler_write_count:0,runtime_tick_count:0,formal_o00_start_authorized:false,formal_window_started:false,formal_execution_count:'0/24',ea5e2_effective_after_merge:true,ea5e3_authorized_after_merge:true,ea5e3_effective:false,ea5e_complete:false,mcft_cap09_completed:false};
