...
function selftest(){
  ...
  const a0p={schema_version:"geox_mcft_cap09_amendment19_formal_a0_evidence_promotion_result_v1",status:"PASS",subject_sha:subject,arm_identity_hash:armId,epoch_id:"epoch",formal_database_name:FORMAL_DATABASE,a0,canonical_fact_write_count:3,formal_fact_count:3,producer_bound_transient_raw_reverification:true,formal_content_addressed_raw_retention_before_decoder:true,normalized_semantics_match_producer_bound_reference:true,raw_sha256_preserved:true,decoder_identity_preserved:true,source_record_identity_preserved:true,transient_ref_present_in_formal_fact:false,provider_refetch_count:0,scheduler_write_count:0,runtime_write_count:0};
